...
export default function AdminDashboard() {
                ...
                try {
                    ...
                    if (permission === 'granted') {
                        ...
                        if (currentToken) {
                            ...
                            await axios.post(`https://6efe-2406-7400-10a-1b0b-82d6-e84e-7fc2-2782.ngrok-free.app/api/auth/fcm-token/${user._id}`, {
    ...
    const fetchZones = async () => {
        try {
            const response = await axios.get('https://6efe-2406-7400-10a-1b0b-82d6-e84e-7fc2-2782.ngrok-free.app/api/zones', {
                headers: {
    ...
    const handleSaveGeofence = async () => {
        ...
        try {
            const url = editingZoneId
                ? `https://6efe-2406-7400-10a-1b0b-82d6-e84e-7fc2-2782.ngrok-free.app/api/zones/${editingZoneId}`
                : 'https://6efe-2406-7400-10a-1b0b-82d6-e84e-7fc2-2782.ngrok-free.app/api/zones';
    ...
    const handleDeleteZone = async (id) => {
        ...
        try {
            await axios.delete(`https://6efe-2406-7400-10a-1b0b-82d6-e84e-7fc2-2782.ngrok-free.app/api/zones/${id}`);
